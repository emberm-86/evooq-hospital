...
public class Rule {
    ...
    private final boolean strict; //strict flag check is necessary unless the patient could die.
    ...
    public static class Builder {
        ...
        private Status to;
        private Drug[] drugs;
        private boolean strict = false; //strict flag check is necessary unless the patient could die.
